...
const fallbackProducts: Product[] = [
  { id: 'meher-festive-suit', title: 'Meher Festive Embroidered Suit', description: 'A softly structured festive edit with hand-finished detail and a modern Pakistani silhouette.', price: 11990, image_url: '/Legacy-Goods-Website/legacy-images/festive-suit.jpg', stock: 8, created_at: '2026-01-01' },
  { id: 'rayan-kurta-waistcoat', title: 'Rayan Kurta Waistcoat Set', description: 'A crisp, considered set for celebrations, cut in breathable local cotton.', price: 8990, image_url: '/Legacy-Goods-Website/legacy-images/men-kurta.jpg', stock: 10, created_at: '2026-01-01' },
  { id: 'naveed-embroidered-waistcoat', title: 'Naveed Embroidered Waistcoat', description: 'Quiet texture, warm neutral tones and a finish made for the occasion.', price: 14990, image_url: '/Legacy-Goods-Website/legacy-images/men-kurta.jpg', stock: 6, created_at: '2026-01-01' },
  { id: 'noor-mint-lawn-suit', title: 'Noor Mint Lawn 3-Piece', description: 'Lightweight lawn in a fresh mint palette, made for long summer afternoons.', price: 6490, image_url: '/Legacy-Goods-Website/legacy-images/women-lawn.jpg', stock: 15, created_at: '2026-01-01' },
  { id: 'gul-teal-khussa', title: 'Gul Teal Embroidered Khussa', description: 'A hand-finished classic with a softly pointed toe and a little colour.', price: 4490, image_url: '/Legacy-Goods-Website/legacy-images/khussa.jpg', stock: 12, created_at: '2026-01-01' },
  { id: 'mina-festive-clutch', title: 'Mina Festive Clutch', description: 'A small evening companion with a tactile finish and just enough shine.', price: 5990, image_url: '/Legacy-Goods-Website/legacy-images/accessories.jpg', stock: 9, created_at: '2026-01-01' },
];
...
export default function Home() {
  ...
  const imageFor = (product: Product) => product.image_url || categoryImage[categoryFor(product)];
