...
export default function Home() {
  ...
  return (
    <main className="storefront">
      ...
      <footer className="site-footer"><div><span className="monogram small">LG</span><p>{brand.name} / {brand.established}</p></div><div><strong>Customer care</strong><span>{brand.supportEmail}</span><span>{brand.supportPhone}</span><span>{brand.supportHours}</span></div><div><strong>Stay close</strong><span>{brand.instagram}</span><span>{brand.address}</span></div></footer>
